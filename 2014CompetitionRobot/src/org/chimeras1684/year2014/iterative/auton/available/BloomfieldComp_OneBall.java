...
public class BloomfieldComp_OneBall extends TimedCommandGroup {
    public BloomfieldComp_OneBall() {
        //shiftHigh is psuedo for kickerOut, shiftLow for kickerIn
        //remembmer : (command)(1) - (arg)(0-3) - (start)(1) - (time)(1)
//        add(shiftLow, 0,0.5);
        add(intakeDown,0,0);
        add(driveForward, 0.4, 1, 1);
        add(driveForward, 0.8, 2, 1);
        add(kickerForward, 1, 2, 4);
        add(shiftHigh, 5, 1);
