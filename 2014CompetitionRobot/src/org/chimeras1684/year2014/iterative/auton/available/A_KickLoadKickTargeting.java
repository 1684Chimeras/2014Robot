...
public class A_KickLoadKickTargeting extends TimedCommandGroup {
    public A_KickLoadKickTargeting() {
        //shiftHigh is psuedo for kickerOut, shiftLow is psuedo for kickerIn
