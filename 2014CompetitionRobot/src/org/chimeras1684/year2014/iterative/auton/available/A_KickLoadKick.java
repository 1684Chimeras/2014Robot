...
public class A_KickLoadKick extends TimedCommandGroup {
    public A_KickLoadKick() {
        add(shiftLow, 0,0.5);
        add(intakeDown, 0, 0.25);
        
        add(upperStructureManual,-0.2,0.5,0.5);
        add(kickerBackward, 0.25, 0.5, 0.25);
        
        add(kickerForward, 0.2, 1, 0.75);
        
        add(kickerForward,1,2,0.35);
        
        //add(upperStructureHome, 3, 0.5);
        
        add(shiftHigh, 3, 0.2);
        add(driveForward, -0.3, 3, 0.25);
        add(intakeIn,3,0.25);
        add(kickerHold, 3, 1.25);
        
        addPauseWhile(ifWait, 3, 1.75);
        addPauseWhile(ifWait, 3.25, 0.5);
        
        add(driveForward,0.3,3.5,1);
        add(rearIntakeUp, 3.25, 0.75);
        add(rearIntakeDown, 4, 0.5);
        addPauseWhile(ifWait, 4, 1);
        
        add(shiftLow, 4.5, 0.5);
        add(intakeDown,4.5,1);
        
        add(upperStructureManual,0.2,5,0.25);
        add(kickerForward,1,5,0.5);
        add(upperStructureManual,-0.2,5.25,0.25);
